# Deep Dictionary — 003_RONAHI

**Status:** MECHANICALLY COMPLETE / INTERPRETATION UNREVIEWED

**Source CSTLK:** `003_RONAHI/CSTLK003RONAHI08172026FDA.docx`  
**Source SHA-256:** `d35a7a27f32c03dded4086e29c6956bc7a46ccce2f4e9bf393f809fbe7a9970b`  
...
- Layer R raw written-token occurrences: **1,947,954**
- Layer R distinct raw written-token types: **108,571**
- Layer W mechanical word-like occurrences: **1,977,137**
- Layer W distinct exact surface forms: **84,532**
- Text containers processed: **153,995**
...
This corpus has **10** complete compressed occurrence/concordance shard(s) under `Occurrences/`. The Actions artifact remains as backup.
